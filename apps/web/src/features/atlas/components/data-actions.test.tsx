...
function progressFile(name: string, mutate: (state: PersistedStateV1) => void) {
...
const selectFrance = (state: PersistedStateV1) => {
...
const selectSpainAndBrazil = (state: PersistedStateV1) => {
