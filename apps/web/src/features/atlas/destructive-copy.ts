 ...
 * and import also replaced projections and the active preset — so a user could
...
export const resetAllCopy = {
	...
	description:
		"This removes selections, custom colors, and color modes for every preset, and restores projections and the active preset to their defaults in this browser. Export first if you may want them later.",
...
export const importCopy = {
	...
	description:
		"This import will replace selections, custom colors, color modes, projections, and the active preset stored in this browser. Review the changes below before replacing your current data. Map geometry is never imported.",
