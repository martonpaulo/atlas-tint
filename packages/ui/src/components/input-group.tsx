...
import { Textarea } from "@atlas-tint/ui/components/textarea";
...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: the reusable input-group wrapper needs group semantics without fieldset styling or form grouping behavior.
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: interactive handlers are consumer-defined; semantic buttons remain buttons through the render prop.
		// biome-ignore lint/a11y/useSemanticElements: this addon groups input adornments and does not represent a fieldset.
		<div
			role="group"
